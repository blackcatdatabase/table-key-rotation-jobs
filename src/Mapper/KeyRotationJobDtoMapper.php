...
namespace BlackCat\Database\Packages\KeyRotationJobs\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO KeyRotationJobDto:
 ...
 */
final class KeyRotationJobDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'basename' => 'basename', 'target_version' => 'targetVersion', 'scheduled_at' => 'scheduledAt', 'started_at' => 'startedAt', 'finished_at' => 'finishedAt', 'status' => 'status', 'attempts' => 'attempts', 'executed_by' => 'executedBy', 'result' => 'result', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'target_version', 'attempts', 'executed_by' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): KeyRotationJobDto
    {
        /** @var KeyRotationJobDto */
        return DtoHydrator::fromRow(
            KeyRotationJobDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?KeyRotationJobDto
    {
     ...
     *
     * @param KeyRotationJobDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KeyRotationJobDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KeyRotationJobDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KeyRotationJobDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KeyRotationJobDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KeyRotationJobDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KeyRotationJobDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KeyRotationJobDto>
     */
