...
use BlackCat\Database\Packages\KeyRotationJobs\Repository\KeyRotationJobRepositoryInterface;
use BlackCat\Database\Packages\KeyRotationJobs\Repository\KeyRotationJobRepository as GeneratedRepository;
...
{
  private KeyRotationJobRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KeyRotationJobRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KeyRotationJobRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyRotationJobs\Dto\KeyRotationJobDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyRotationJobs\Dto\KeyRotationJobDto|null { return $this->repo->getById($id, $asDto); }
