...
{
    private KeyRotationJobRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KeyRotationJobRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KeyRotationJobs\Dto\KeyRotationJobDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KeyRotationJobs\Dto\KeyRotationJobDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KeyRotationJobs\Dto\KeyRotationJobDto|null
    {
