...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'basename', 'target_version', 'scheduled_at', 'started_at', 'finished_at', 'status', 'attempts', 'executed_by', 'result', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KeyRotationJobs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KeyRotationJobs\Definitions::softDeleteColumn();
