 ...
 * - whitelist LIKE:   [ 'basename', 'status', 'result' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'basename', 'target_version', 'scheduled_at', 'started_at', 'finished_at', 'status', 'attempts', 'executed_by', 'result', 'created_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'basename', 'target_version', 'scheduled_at', 'started_at', 'finished_at', 'status', 'attempts', 'executed_by', 'result', 'created_at' ], true);
            $parts = [];
