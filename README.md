...
| Pkg folder | [packages/key-rotation-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/key-rotation-jobs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-rotation-jobs -Apply
