...
- Pkg folder: [packages\key-rotation-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\key-rotation-jobs)
...
graph LR
  ...
  key_rotation_jobs["key_rotation_jobs"]:::center
  key_rotation_jobs -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package key-rotation-jobs -Apply
