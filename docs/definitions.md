...
| --- | --- | --- | --- |
| vw_key_rotation_jobs | mysql | algorithm=MERGE, security=INVOKER | [packages\key-rotation-jobs\schema\040_views.mysql.sql](https://github.com/blackcatacademy/blackcat-database/packages/key-rotation-jobs/schema/040_views.mysql.sql) |
| vw_key_rotation_jobs | postgres |  | [packages\key-rotation-jobs\schema\040_views.postgres.sql](https://github.com/blackcatacademy/blackcat-database/packages/key-rotation-jobs/schema/040_views.postgres.sql) |
